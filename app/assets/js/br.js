...
$(document).ready(function() {
   ...
   * zoom
   */
  var DZ, changeA, content, enableDropZone, init, isPortait, markedIt, myDropzone, reDraw, reWrite, styleSheet, styleSheetList, zoom;
  /*
   * MDC
   */
  // MDC AutoInit
   ...
   * FAB
   */
  [].forEach.call(document.querySelectorAll('.mdc-fab'), function(fab) {
    mdc.ripple.MDCRipple.attachTo(fab);
  });
  /*
   * Icon Button
   */
  [].forEach.call(document.querySelectorAll('[data-mdc-ripple-is-unbounded]'), function(iconButtonEl) {
   ...
   * Linear Progress
   */
  [].forEach.call(document.querySelectorAll('.mdc-linear-progress'), function(progressEl) {
    var linearProgress;
    linearProgress = mdc.linearProgress.MDCLinearProgress.attachTo(progressEl);
   ...
   * Radio
   */
  [].forEach.call(document.querySelectorAll('.demo-radio-form-field'), function(formField) {
    var formFieldInstance, radio;
    formFieldInstance = new mdc.formField.MDCFormField(formField);
    radio = formField.querySelector('.mdc-radio');
    if (radio) {
   ...
   * Select
   */
  [].forEach.call(document.querySelectorAll('.mdc-select:not(select)'), function(select) {
    mdc.select.MDCSelect.attachTo(select);
  });
  /*
   * Slider
   */
  [].forEach.call(document.querySelectorAll('.mdc-slider'), function(slider) {
   ...
   * Text Field
   */
  [].forEach.call(document.querySelectorAll('.mdc-text-field'), function(textField) {
  ...
  styleSheet = null;
  _.each(styleSheetList, function(CSSStyleSheet, i) {
    if (CSSStyleSheet.title === 'page') {
      styleSheet = CSSStyleSheet;
      //styleSheet.insertRule("html { font-size: 100%;}", 1)
      return console.log(styleSheet);
    }
  });
  zoom = function() {
    var bh, sh, z;
  ...
  changeA = function() {
    var index, mode, orientation, rule, size;
    orientation = $('[data-orientation]').attr('data-orientation');
    mode = $('[data-mode]').attr('data-mode');
    if (isPortait()) {
      orientation = 'portait';
    } else {
    ...
    if ($(window).width() > 560 && $(window).width() <= 794) {
      size = 'A5';
    } else if ($(window).width() > 794 && $(window).width() <= 1136) {
      size = 'A5';
    } else if ($(window).width() > 1136) {
      size = 'A4';
    }
    $('body, html, aside, article').attr('class', '');
    $('body, html, aside, article').addClass(size).addClass(orientation);
    if (mode !== '') {
      $('body').addClass(mode);
    }
    ...
    $('[data-orientation]').attr('data-orientation', orientation);
    return console.log('rule', rule);
  };
  ...
  //reDraw content
  $(window).on('debouncedresize.zoom', function() {
    return setTimeout(function() {
      return changeA();
    }, 333);
  });
  ...
  return $('[data-orientation]').on('click', function() {
    ...
    orientationOrig = 'landscape';
    orientationAlt = 'portait';
    //console.log 'orientation', orientation
    if (orientation === orientationOrig) {
      $(this).attr('data-orientation', orientationAlt);
      return $('body, html, aside, article').removeClass(orientationOrig).addClass(orientationAlt);
    } else {
      $(this).attr('data-orientation', orientationOrig);
      return $('body, html, aside, article').removeClass(orientationAlt).addClass(orientationOrig);
    }
  });
});

}).call(this,typeof global !== "undefined" ? global : typeof self !== "undefined" ? self : typeof window !== "undefined" ? window : {})
},{"./_debouncedresize":4,"jquery":1,"keymaster":2,"underscore":3}]},{},[5]);
